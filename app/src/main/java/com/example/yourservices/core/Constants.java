...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.example.yourservices";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "Your Services";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.example.yourservices.sync";
    ...
    public static final class Extra {
        ...
        public static final String DISCOUNT_OFFER_ITEM = "discount_offer_item";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.example.yourservices.";
